/**
 * IntersectionBoardRenderer - Renders 9x5 intersection grid for Three Kingdoms Dark Chess (T061-T062)
 * Intersection-based layout with grid lines and pieces at intersections
 */
...
// Board dimensions for Three Kingdoms: 9 columns x 5 rows (45 intersections)
const GRID_COLS = 9;
const GRID_ROWS = 5;
const TOTAL_INTERSECTIONS = 45;

// Calculate intersection spacing based on screen dimensions
const { width: screenWidth, height: screenHeight } = Dimensions.get('window');
const BOARD_PADDING = 24;
const HEADER_FOOTER_SPACE = 280;

const availableWidth = screenWidth - (BOARD_PADDING * 2);
const availableHeight = screenHeight - HEADER_FOOTER_SPACE;

// Calculate spacing to fit the grid
...
// Use smaller spacing to maintain aspect ratio
